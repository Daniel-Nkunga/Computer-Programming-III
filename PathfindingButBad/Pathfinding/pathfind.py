...
def astar(array, start, goal):
    ...
    while oheap:
        ...
        # Show the image with the search process
        cv2.imshow("Search Process", maze_image_resized)
        cv2.waitKey(1)  # Adjust the delay between frames (in milliseconds)
    
    return False

# Load the maze image
maze_image = cv2.imread(r'C:\Users\danie\Desktop\Coding Spring 2024\Computer-Programming-III\Pathfinding\BWMaze.png', cv2.IMREAD_COLOR)
...
path = astar(maze_array, start, end)
